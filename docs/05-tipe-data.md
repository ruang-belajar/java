...
| char      | Menyimpan data berupa satu karakter. Data dengan tipe data char ditulis menggunakan tanda kutip tunggal (`'`) |
...
String nama = "Budi";
Integer usia = 20;
Integer tinggi = Integer.valueOf(160);
Integer berat = new Integer(60);
